...
function LandingPage({ onNavigate }: { onNavigate: (path: string) => void }) { /* ... LandingPage code ... */
	...
	<div className="flex gap-4 justify-center mt-4">
            <button
              ...
              className={`px-6 py-2 rounded-full shadow-sm border font-medium transition duration-200 ${
                selectedDevice === 'thermomix'
	...
	<button onClick={() => onNavigate('/custom')} className="bg-green-600 hover:bg-green-700 text-white font-semibold px-8 py-3 rounded-full shadow-md w-full sm:w-auto transition duration-300 ease-in-out transform hover:scale-105" > Tarif Oluştur 🚀 </button>
	
{/* 👇 Beğenilen tariflere yönlendirme butonu */}
<button
...
>
  💚 Beğenilen Tarifleri Gör
	...
	</div> <div className="grid grid-cols-3 gap-4 mt-10 w-full max-w-md"> <button className="category-btn flex flex-col items-center justify-center p-4 bg-gray-100 hover:bg-gray-200 rounded-lg shadow text-center space-y-1 transition duration-300 ease-in-out"> <span className="text-4xl mb-1">🍲</span> <span className="font-medium text-gray-700">Evdeki Malzemelerini Seç!</span> <span className="text-xs text-gray-500"></span> </button> <button className="category-btn flex flex-col items-center justify-center p-4 bg-gray-100 hover:bg-gray-200 rounded-lg shadow text-center space-y-1 transition duration-300 ease-in-out"> <span className="text-4xl mb-1">🍹</span> <span className="font-medium text-gray-700">Yapay Zeka Sana Özel Tarifi Oluştursun!</span> <span className="text-xs text-gray-500"></span> </button> <button className="category-btn flex flex-col items-center justify-center p-4 bg-gray-100 hover:bg-gray-200 rounded-lg shadow text-center space-y-1 transition duration-300 ease-in-out"> <span className="text-4xl mb-1">🍰</span> <span className="font-medium text-gray-700">ThermoGusto yada Thermomix ile adım adım pişir!</span> <span className="text-xs text-gray-500"></span> </button> </div> </main> <footer className="text-center py-6 text-sm text-gray-500 border-t mt-10 bg-white">
