        ...
        <div className="bg-white p-6 rounded-lg shadow-xl animate-fade-in">
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            {currentStep < recipe.steps.length ? (
              <button onClick={() => setCurrentStep((prev) => prev + 1)} className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-full shadow-md transition duration-300 transform hover:scale-105" > Sonraki &rarr; </button>
            ) : (
